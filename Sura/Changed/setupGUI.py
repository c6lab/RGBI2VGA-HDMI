...
sliderF=sg.Frame(layout=[[
     sg.Slider((5000, 11000), orientation='h', enable_events=True, key='-SLIDERF-',size=(250,20))          
...
block0=[
         [sg.Frame(layout=[[sg.Radio('VGA', "VIDEOMODE", default=True, size=(5, 1),key="isVGAout",disabled=False),
                           ...
                           sg.Radio('RGB', "VIDEOMODE",  size=(5, 1),key="isRGBout",disabled=False),
                           sg.Radio('COMP', "VIDEOMODE",  key="isCOMPout",disabled=False)],
                           [
                               sg.Push(),sg.Frame(layout=[[sg.CBox('широкоэкранный', key='is_widescreen')]], title=" пропорции ",title_location=sg.TITLE_LOCATION_TOP,key="WIDE_MODE_BLOCK"),sg.Push()],[                            
